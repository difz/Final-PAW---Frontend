...
const KategoriPengeluaran: React.FC<KategoriPengeluaranProps> = ({ currentCategory, categories, onAddCategory, onSelectCategory, onClose }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white w-96 p-6 rounded shadow-md">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold">Pilih Kategori Pengeluaran</h2>
